    ...
    <div class="max-w-5xl mx-auto px-6 py-12">
        ...
        <section class="mb-16">
            <div class="prose max-w-none text-gray-700 leading-relaxed">
                <p>
                    Jesus declared, <em>“The harvest is plentiful, but the laborers are few” (Matthew 9:37, ESV).</em>
                    In response to this urgent call, the Philippine-Micronesia Theological Education by Extension for Nazarenes (PhilMicTEEN) program exists to raise well-trained, Spirit-filled leaders who will serve God faithfully in the Church of the Nazarene—pastors, missionaries, church workers, and committed laypersons.
                </p>
        ...
        <section class="mb-16">
            ...
            <div class="grid md:grid-cols-2 gap-6 text-gray-700">
                ...
                <div class="bg-white p-5 rounded-xl shadow">
                    <strong>Assessment & Credentialing</strong>
                    <p class="text-sm mt-2">
        ...
        <section class="mb-16">
            ...
            <div class="prose max-w-none text-gray-700 leading-relaxed">
                ...
                <ul>
                    <li>Program oversight across all extension centers</li>
                    <li>Church partnerships and promotion</li>
                    <li>Student development and faculty supervision</li>
                    <li>Logistics, training, and reporting</li>
                    <li>Contextual application with academic rigor</li>
                </ul>
