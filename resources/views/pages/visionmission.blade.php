    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="text-center mb-14">
            ...
            <p class="text-gray-500 max-w-2xl mx-auto">
                Guiding principles that shape our commitment to excellence, faith, and service.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <!-- Mission -->
            <div class="bg-white p-10 rounded-2xl shadow-lg border-t-4 border-blue-600 hover:shadow-xl transition">
            ...
            <!-- Vision -->
            <div class="bg-white p-10 rounded-2xl shadow-lg border-t-4 border-green-600 hover:shadow-xl transition">
                <div class="flex items-center mb-4">
