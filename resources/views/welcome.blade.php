...
function staffComponent() {
    return {
        ...
        staff: [
            ...
            {id: 9, name: 'Lionel G. Saquilabon', role: 'College Faculty', category: 'college', img: '/images/temporary.jpg'},
            {id: 10, name: 'Evan Rey T. Macasa', role: 'Chaplain / College Faculty', category: 'college', img: '/images/temporary.jpg'},
            {id: 11, name: 'Sophia Alder L. Samson', role: ' Guidance Advocate', category: 'staff', img: '/images/temporary.jpg'},
            {id: 12, name: 'Nathalie Cabalda', role: ' Bookkeeper', category: 'staff', img: '/images/temporary.jpg'},
            {id: 13, name: 'Marie Ruth V. Pastor', role: ' Cashier', category: 'staff', img: '/images/temporary.jpg'},
            {id: 14, name: 'David Lloyd B. Open', role: ' Custodian', category: 'staff', img: '/images/temporary.jpg'},
            {id: 15, name: 'Fernando Magos', role: ' Maintenance', category: 'staff', img: '/images/temporary.jpg'},
            {id: 16, name: 'Nerhez C. Sanchez', role: ' College Faculty', category: 'college', img: '/images/temporary.jpg'},
            ...
            {id: 18, name: 'Verlie R. Amistoso', role: ' Grade 8 Adviser / BGB Coordinator', category: 'basiced', img: '/images/basiced/verlie.jfif'},
            ...
            {id: 28, name: 'Meridisa M. Canonigo', role: ' Teacher Grade 10 Adviser', category: 'basiced', img: '/images/temporary.jpg'},
            {id: 29, name: 'Larry D. Babao', role: ' High School Coordinator / AP Teacher', category: 'basiced', img: '/images/temporary.jpg'},
            {id: 30, name: 'John Quiachon', role: ' IT - Coordinator / Computer Teacher', category: 'staff', img: '/images/temporary.jpg'},
