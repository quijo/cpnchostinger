...
function staffComponent() {
    return {
        ...
        staff: [
            ...
            {id: 24, name: 'Rezzie Mae I. Paulo ', role: ' Teacher Grade 5 Adviser', category: 'basiced', img: '/images/basiced/r_paulo.jpg'},
            {id: 25, name: 'Julie B. Presbitero ', role: ' Teacher Grade 6 Adviser/ Elementary Coordinator', category: 'basiced', img: '/images/basiced/j_presbitero.jpg'},
            {id: 26, name: 'Sheen Gapo', role: ' Teacher Grade 7 Adviser', category: 'basiced', img: '/images/basiced/sheen.jfif'},
